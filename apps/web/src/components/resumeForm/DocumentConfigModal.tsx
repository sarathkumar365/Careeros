...
const FONT_OPTIONS = DocumentSetupSchema.shape.font._def.innerType._def
  .values as ReadonlyArray<string>
const FONT_SIZE_OPTIONS = DocumentSetupSchema.shape.fontSize._def.innerType._def
  .values as ReadonlyArray<string>
const MARGIN_OPTIONS = DocumentSetupSchema.shape.margin._def.innerType._def
  .values as ReadonlyArray<string>
const PAPER_SIZE_OPTIONS = DocumentSetupSchema.shape.paperSize._def.innerType
  ._def.values as ReadonlyArray<string>
