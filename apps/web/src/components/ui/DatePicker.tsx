  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={onClick}
        className="w-full border-b border-gray-400 px-3 py-2 text-left focus:border-b focus:border-black focus:outline-none"
      >
        {value ? (
...
function Calendar({
  ...
  return (
    <div className="absolute z-50 mt-1 w-60 border bg-white p-4">
              ...
              className={`py-0 text-center text-sm ${
                isPast
                  ...
                  : isSelected
                    ...
                    : 'text-slate-800 hover:bg-gray-300'
              }`}
            >
              {day}
            </button>
