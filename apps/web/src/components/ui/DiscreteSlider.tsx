    ...
    <div className="w-full space-y-3">
      ...
      <div className="flex items-center gap-3">
        <div className="relative flex flex-1 items-center justify-between px-4">
          <div className="absolute top-1/2 right-4 left-4 h-[1px] bg-black" />
          <div
            ref={indicatorRef}
          ...
          {values.map((v) => (
            <button
              ...
              onClick={() => onChange(v)}
              className="relative z-10 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-white text-sm font-medium hover:bg-gray-300"
            >
