...
interface ResumeState {
  ...
  isMatchingTailoredResume: boolean
...
export const useResumeStore = create<ResumeState>()(
  persist(
    (set, get) => ({
      ...
      setParsingResume: (isLoading: boolean) => {
        set({ isParsingResume: isLoading })
      },

      setParsingChecklist: (isLoading: boolean) => {
        set({ isParsingChecklist: isLoading })
      },

      setTailoringResume: (isLoading: boolean) => {
        set({ isTailoringResume: isLoading })
      },

      setMatchingTailoredResume: (isLoading: boolean) => {
        set({ isMatchingTailoredResume: isLoading })
      },
    }),
    {
